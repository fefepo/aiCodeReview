...
## 👨‍💻 담당 역할
1) 백엔드 개발 (DB 모델링, REST API 설계, JWT 인증/권한 관리, Junit 테스트 코드 작성, 비즈니스 로직 구현)
2) 프론트엔드 개발 (주요 페이지 UI 구현 및 통계/성능 데이터 시각화)
3) AI 데이터셋 구축 (GitHub PR 데이터 수집 및 LLaMA 파인튜닝용 전처리)
