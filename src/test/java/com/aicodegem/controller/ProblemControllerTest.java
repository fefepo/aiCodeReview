...
public class ProblemControllerTest {
    ...
    public void testSubmitProblemRequest() throws Exception {
        ...
        savedRequestId = JsonPath.read(responseBody, "$.id");
    }
    ...
    public void testSearchByTitle() throws Exception {
        ...
        List<Problem> problems = Arrays.asList(problem1, problem2);
        Page<Problem> problemPage = new PageImpl<>(problems, PageRequest.of(page - 1,
                size), problems.size());

        when(problemService.searchByTitle(eq(title),
